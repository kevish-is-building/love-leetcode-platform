  ...
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center overflow-hidden bg-black py-16 text-white sm:px-6 lg:px-8 lg:py-2">
      ...
      <div className="absolute inset-0 z-0">
        {/* Radial gradient */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-indigo-900/30 via-black/70 to-gray-950 blur-3xl"></div>
      ...
      <div className="fadein-blur relative z-0 mx-auto mb-10 h-75 w-75 lg:absolute lg:top-1/2 lg:right-1/2 lg:mx-0 lg:mb-0 lg:h-125 lg:w-125 lg:translate-x-1/2 lg:-translate-y-2/3">
        ...
        <motion.div
          ...
          className="absolute top-4 -left-4 rounded-sm border border-purple-500/30 bg-black/80 p-2 backdrop-blur-md lg:top-1/4 lg:-left-20"
        >
        ...
        <motion.div
          variants={tooltipVariants}
          className="absolute top-1/2 -right-4 rounded-sm border border-blue-500/30 bg-black/80 p-2 backdrop-blur-md lg:-right-24"
        >
          <div className="flex items-center gap-2">
        ...
        <motion.div
          variants={tooltipVariants}
          className="absolute bottom-4 left-4 rounded-sm border border-indigo-500/30 bg-black/80 p-2 backdrop-blur-md lg:bottom-1/4 lg:left-8"
        >
          <div className="flex items-center gap-2">
      ...
      <motion.main
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 mb-10 flex w-full max-w-362.5 grow flex-col items-center justify-center px-4 text-center sm:px-8 lg:mb-0 lg:items-start lg:justify-end lg:text-left"
      >
        <motion.div className="flex w-full flex-col items-center justify-between lg:flex-row lg:items-start">
          <div className="w-full lg:w-auto">
            ...
            <motion.div
              variants={itemVariants}
              className="mb-6 mt-2 flex flex-wrap justify-center gap-4 md:gap-6 lg:justify-start"
            >
              <div className="rounded-sm border border-purple-500/20 bg-black/40 px-4 py-2 backdrop-blur-sm">
                <p className="text-2xl font-bold text-white">
                  {stats.users.toLocaleString()}+
                </p>
                <p className="text-xs text-gray-400">Active Users</p>
              </div>
              <div className="rounded-sm border border-blue-500/20 bg-black/40 px-4 py-2 backdrop-blur-sm">
                <p className="text-2xl font-bold text-white">
                  {stats.submissions.toLocaleString()}+
                </p>
                <p className="text-xs text-gray-400">Submissions</p>
              </div>
              <div className="rounded-sm border border-indigo-500/20 bg-black/40 px-4 py-2 backdrop-blur-sm">
                <p className="text-2xl font-bold text-white">
                  {stats.networks}+
                </p>
          ...
          <div className="mt-6 flex flex-col items-center lg:mt-0 lg:items-end">
            ...
            >
              <Button
                className="group rounded-full border-t border-purple-400 bg-linear-to-b from-purple-700 to-slate-950/80 px-6 py-6 text-white shadow-lg shadow-purple-600/20 transition-all hover:shadow-purple-600/40"
                size="lg"
              >
                Start Solving Now
            ...
            >
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  ...
                  >
                    <div className="h-full w-full bg-linear-to-br from-purple-500 to-blue-600 opacity-80"></div>
                  </div>
                ))}
              </div>
